...
export class PunkBodies extends ethereum.SmartContract {
  static bind(address: Address): PunkBodies {
    return new PunkBodies("PunkBodies", address);
  }
  ...
  IMAGE_PROOF(): Bytes {
    let result = super.call("IMAGE_PROOF", "IMAGE_PROOF():(bytes32)", []);

    return result[0].toBytes();
  }

  try_IMAGE_PROOF(): ethereum.CallResult<Bytes> {
    let result = super.tryCall("IMAGE_PROOF", "IMAGE_PROOF():(bytes32)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  METADATA_PROOF(): Bytes {
    let result = super.call("METADATA_PROOF", "METADATA_PROOF():(bytes32)", []);

    return result[0].toBytes();
  }

  try_METADATA_PROOF(): ethereum.CallResult<Bytes> {
    let result = super.tryCall(
      "METADATA_PROOF",
      "METADATA_PROOF():(bytes32)",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
